                        ...
                        if(mysqli_num_rows($run_query) > 0){
                            while($row = mysqli_fetch_array($run_query)){
                                if($row['categorie'] == $cat_id){
                                    ...
                                    $resultat_vendeur = mysqli_query($con, $query_vendeur);
                                    $vendeur = "";
                                    if ($resultat_vendeur && mysqli_num_rows($resultat_vendeur) > 0) {
                                        $vendeur_ligne = mysqli_fetch_assoc($resultat_vendeur);
                                        $vendeur = $vendeur_ligne['pseudo'];
                                    }
